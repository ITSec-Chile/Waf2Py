...
def scheduler_summary():
    #this method work only for small files with 260mb file it can consume all the memory. Used system crontab instead
    ...
    for app in q:
        ...
        critical = 0
        error = 0
        transactions = str(x, 'utf-8', errors='ignore').splitlines()
